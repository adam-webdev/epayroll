      ...
      <div class="card-body-bmb">
        ...
        <table class="table table-responsive">
          <tbody>
              ...
              <tr>
                  <td width="20%"><strong>Link Tokopedia</strong></td>
                  <td>:</td>
                  <td><a href="{{ $produk->link_tokped }}" target="_blank">{{ $produk->link_tokped }}</a></td>
              </tr>
              <tr>
                  <td width="20%"><strong>Link Shopee</strong></td>
                  <td>:</td>
                  <td><a href="{{ $produk->link_shopee }}" target="_blank">{{ $produk->link_shopee }}</a></td>
              </tr>
              <tr>
